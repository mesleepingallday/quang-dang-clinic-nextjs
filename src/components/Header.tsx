      ...
      >
              ...
              >
                <Image
                  ...
                  className={`object-contain transition-all duration-300 ${
                    isHomePage && !isScrolled ? 'p-1 drop-shadow-sm' : ''
                  }`}
                  priority
                />
              </div>
        ...
        <div
          className={`transition-all duration-500 ${
            isScrolled
              ? 'bg-green-50/95 backdrop-blur-sm py-1'
              : isHomePage
              ? 'bg-transparent py-3'
              : 'bg-green-50 py-3'
          }`}
        >
          <div className="container mx-auto px-4 md:px-8">
            <div className="flex items-center justify-between">
              ...
              {/* Mobile/Tablet - Center Logo + Menu Buttons */}
              <div className="flex lg:hidden items-center justify-between w-full">
                {/* Empty div for spacing on mobile to center logo */}
                <div className="w-10" />

                {/* Mobile Logo - Already shown in line 1, so we show small version here or nothing */}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    type="button"
                    onClick={openSearch}
                    className={`p-2 rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 ${
                  ...
                  <button
                    type="button"
                    className={`p-2 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 ${
