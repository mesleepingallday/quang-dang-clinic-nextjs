  ...
  return (
    <div className="min-h-screen bg-nude-50">
      ...
      <div className="pt-24 pb-12 bg-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/3 h-full bg-gold-50/50 skew-x-12 transform translate-x-20 z-0"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-10">
            <span className="text-gold-600 font-bold tracking-widest text-sm uppercase mb-3 inline-block">
              Booking Online
            </span>
            <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              ...
              <span className="text-gold-600 italic">Nhận Ưu Đãi Độc Quyền</span>
            </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-5/12 order-2 lg:order-1 lg:sticky lg:top-24">
            <BookingForm
              ...
              isAdvanced={true}
              className="shadow-2xl ring-1 ring-gold-100"
            />
          ...
          <div className="w-full lg:w-7/12 order-1 lg:order-2 space-y-16">
            ...
            {/* Promotion Banner */}
            <div className="bg-gradient-to-r from-gold-600 to-gold-400 text-white p-6 rounded-2xl shadow-lg flex items-center justify-between relative overflow-hidden group">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={idx} className="flex gap-4 p-4 bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                    <div className="shrink-0 w-12 h-12 bg-gold-50 rounded-full flex items-center justify-center text-gold-600">
                      <item.icon size={24} />
                    </div>
                    <div>
            ...
            <div className="bg-nude-100 p-8 rounded-2xl">
              <h3 className="font-serif text-2xl font-bold text-gray-800 mb-6">Bạn Đang Lo Lắng?</h3>
              <div className="space-y-4">
                <details className="group bg-white rounded-lg border border-gold-100 overflow-hidden">
            ...
            <div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-gold-50 rounded-full flex items-center justify-center text-gold-600 shrink-0">
                    <MapPin size={20} />
                  </div>
                  <div>
                    ...
                    <a href="https://maps.google.com/?q=TTTM+Đức+Tài" target="_blank" rel="noopener noreferrer" className="text-gold-600 text-sm font-semibold hover:underline">Xem chỉ đường Google Maps →</a>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-gold-50 rounded-full flex items-center justify-center text-gold-600 shrink-0">
