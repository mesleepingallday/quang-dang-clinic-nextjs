    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="pt-32 pb-12 bg-nude-50 border-b border-gold-100">
        <div className="container mx-auto px-4 max-w-4xl text-center">
           <div className="flex items-center justify-center gap-2 text-sm text-gold-600 font-bold uppercase tracking-wide mb-4">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-2/3">
             ...
             {/* Introduction */}
             <p className="text-xl text-gray-700 font-serif italic border-l-4 border-gold-500 pl-6 mb-10 leading-relaxed">
               {post.excerpt}
             </p>
             ...
             {post.author && (
               <div className="flex items-start gap-6 bg-gray-50 p-8 rounded-2xl border border-gray-100 mt-12">
                 ...
                 <div>
                   ...
                   {post.author.role && (
                     <p className="text-gold-600 text-sm font-bold uppercase mb-3">
                       {post.author.role}
                     </p>
                   )}
                   {post.author.bio && (
          ...
          <div className="lg:w-1/3">
             <div className="sticky top-24 space-y-8">
                ...
                {post.relatedServices && post.relatedServices.length > 0 && (
                  <div className="bg-gold-600 text-white p-6 rounded-2xl shadow-xl relative overflow-hidden">
